import InsideDrawer, {InsideDrawerProps} from "../App/components/Header/Drawer/InsideDrawer";
...
function renderInsideDrawer(props: Partial<InsideDrawerProps> = {}) {
    ...
    return render(<BrowserRouter><InsideDrawer {...defaultProps} {...props}/></BrowserRouter>);
};
