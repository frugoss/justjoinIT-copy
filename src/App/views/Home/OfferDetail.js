...
const OfferDetail = ({offersList, match, history, filters, fetching, setHideFilter}) => {
    ...
    function Dropzone({onChange, values}) {
                                ...
                                <div id="apply" className={styles.cvContainer}>
                                    ...
                                    <div className={styles.introCV}>
                                        ...
                                        <div className={styles.CV}>
                                            <Field name="file">
                                                {props => (
                                            <Dropzone values={values} acceptedFiles=".pdf" multiple={false} onChange={props.input.onChange}/>
                                                )}</Field>
                                        </div>
                                    </div>
